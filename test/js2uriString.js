...
exports['js2uri'] = {
  ...
  'js2uriString encoding tests': function(test) {
    ...
    test.deepEqual(grunt.helper('js2uriString', '', true),
      'javascript:',
      'js2uriString null should return "javascript:"');
    ...
    // unescaped test code is: var a=["0","1"],b='0%';if(a[1]>0){writeln("true"+b)}
    test.deepEqual(grunt.helper('js2uriString', "var a=[\"0\",\"1\"],b='0%';if(a[1]>0){writeln(\"true\"+b)}", true),
      "javascript:var%20a=%5B%220%22,%221%22%5D,b='0%25';if(a%5B1%5D%3E0)%7Bwriteln(%22true%22+b)%7D",
